...
class UpdateBridgeContractTest {
    ...
    fun `start arguments require exact safe schema`() {
        ...
        assertEquals("juicr-android-v2.0.0-x86_64.apk", parsed?.assetName)
    ...
    private fun validArguments(): Map<String, Any> = linkedMapOf(
        ...
        "assetName" to "juicr-android-v2.0.0-x86_64.apk",
        "assetUrl" to "https://github.com/Team-Juicr/Juicr/releases/download/v2.0.0/juicr-android-v2.0.0-x86_64.apk",
