...
class VlcPlayerController extends ValueNotifier<VlcPlayerValue> {
  ...
  ///
  /// If VLC has reported a positive duration and [moment] is outside of the
  /// video's full range it will be automatically and silently clamped. Unknown
  /// duration streams still pass positive seeks through to VLC so HLS/live-like
  /// streams can resume after VLC metadata remains at zero.
